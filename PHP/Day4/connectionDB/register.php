...
<body>
    <h1 class="text-info text-center my-2">User Registration Page </h1>
    <?php
    if (isset($_GET['error'])){
    ...
    ?>
    <form enctype="multipart/form-data" action="server.php" method="post" class="my-5 mx-auto p-5 border border-2 rounded w-50">
        ...
        <!-- <div class="form-group">
            ...
            <input name="userImage" type="file" class="form-control" id="exampleInputImage1" placeholder="Upload Image">
        </div> -->
        <div class="form-group">
        ...
        <button name="btn-register" type="submit" class="btn btn-primary">Submit</button>
    </form>
