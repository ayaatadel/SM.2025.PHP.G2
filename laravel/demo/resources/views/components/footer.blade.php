<div>
    <footer class="py-5 border rounded text-center mt-5 bg-dark text-light w-100">
        <div class="row">
        ...
        <div class="d-flex  justify-content-between py-4 my-4 border-top text-center">
            <p style="text-align: center" class="w-50 m-auto"> © 2025 ITI, Inc. All rights reserved.</p>
